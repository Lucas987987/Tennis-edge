...
Tennis · 141 matchs analysés · 7 derniers jours
...
Opérateurs agréés ANJ — marge moyenne (plus bas = prix rendu plus élevé) :
  ...
  pmu : 7.3% (48 matchs)
  bet365.fr : 10.3% (107 matchs)

Références de marché (servent au calcul du juste prix, non promues) :
  betfair-ex : marge 1.0% (139 matchs)
  pinnacle : marge 3.3% (135 matchs)
...
Écart moyen au juste prix estimé (0% = prix fair) :
  ...
  bet365.fr : -12.0% · suivi plus lâche
