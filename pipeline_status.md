...
Run démarré `2026-09-01T04:57:31` · terminé `2026-09-01T05:21:35` (UTC)
...
| Audit des moves (live) | `moves_detail.csv` | 4 | 601 | ✅ OK |
...
| Courbes live reconstruites | `book_curves_live.jsonl` | 2980 | 42422899 | ✅ OK |

**Partitions** : 73 fichiers, 734.4 Mo au total.
...
⚠️ **Études Polymarket** : 1 échec(s) · 2 avertissement(s) (info) (il y a 18.2h)
