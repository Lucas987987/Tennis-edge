...
Run démarré `2026-09-04T18:25:30` · terminé `2026-09-04T18:43:51` (UTC)

**Verdict : 1 livrable(s) à vérifier**

| Livrable | Fichier | Lignes | Octets | État |
|---|---|---:|---:|---|
| Résultats match + set | `set_results.json` | 2572 | 256908 | ✅ OK |
| Pont résultats (études) | `resultats_derived.json` | 1687 | 446843 | ✅ OK |
...
| Courbes live reconstruites | `book_curves_live.jsonl` | 1365 | 7020206 | ✅ OK |

**Partitions** : 37 fichiers, 327.0 Mo — ⚠️ **vue partielle** (sparse-checkout : pm_ticks/kx_ticks absents de ce run). La taille réelle du dépôt est celle de la sentinelle ci-dessous, pas celle-ci.
...
✅ **Études Polymarket** : 0 échec(s) · 2 avertissement(s) (info) (il y a 9.8h)
