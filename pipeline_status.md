...
Run démarré `2026-08-20T01:50:50` · terminé `2026-08-20T01:58:06` (UTC)

**Verdict : 2 livrable(s) à vérifier**

| Livrable | Fichier | Lignes | Octets | État |
|---|---|---:|---:|---|
| Résultats match + set | `set_results.json` | 1903 | 191179 | ✅ OK |
...
| Audit des moves (live) | `moves_detail.csv` | 16 | 2495 | ✅ OK |
...
| Courbes live reconstruites | `book_curves_live.jsonl` | 1072 | 11545646 | ✅ OK |

**Partitions** : 18 fichiers, 332.2 Mo au total.
