...
Run démarré `2026-08-16T12:58:04` · terminé `2026-08-16T13:04:08` (UTC)
...
| Audit des moves (live) | `moves_detail.csv` | 60 | 9375 | ✅ OK |
| Audit des moves (historique) | `moves_detail_hist.csv` | 831 | 133742 | ✅ OK |
| CLV réalisé du canal public | `canal_clv_detail.csv` | 19 | 1148 | ✅ OK |
| Courbes live reconstruites | `book_curves_live.jsonl` | 3910 | 28373082 | ✅ OK |

**Partitions** : 25 fichiers, 637.3 Mo au total.
