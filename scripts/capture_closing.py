...
def main():
    ...
    for m in matches:
        ...
        # [DIAG] Dédoublonnage désactivé temporairement — stocke CHAQUE passage
        # pour mesurer le vrai rythme d'exécution de GitHub Actions
        ...
        captured += 1
        # Limiter à 200 points max par match (garde les plus récents)
        if len(hist) > 200:
            closing[uid]['history'] = hist[-200:]
