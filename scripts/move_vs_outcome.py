...
# Règle centralisée dans player_key.py. L'ancienne version acceptait UN SEUL
# jeton commun de 4+ lettres -- donc un prénom partagé (Alexander Zverev ≡
# Alexander Bublik). 133 matchs sur 1286 recevaient un vainqueur erroné.
